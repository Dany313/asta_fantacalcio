...
void _playerSerialize(
  ...
  writer.writeLong(offsets[0], object.acqValue);
...
Player _playerDeserialize(
  ...
  final object = Player(
    acqValue: reader.readLong(offsets[0]),
    id: id,
...
extension PlayerQueryFilter on QueryBuilder<Player, Player, QFilterCondition> {
  QueryBuilder<Player, Player, QAfterFilterCondition> acqValueEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Player, Player, QAfterFilterCondition> acqValueGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Player, Player, QAfterFilterCondition> acqValueLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Player, Player, QAfterFilterCondition> acqValueBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlayerQuerySortBy on QueryBuilder<Player, Player, QSortBy> {
  QueryBuilder<Player, Player, QAfterSortBy> sortByAcqValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'acqValue', Sort.asc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> sortByAcqValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'acqValue', Sort.desc);
    });
  }
...
extension PlayerQuerySortThenBy on QueryBuilder<Player, Player, QSortThenBy> {
  QueryBuilder<Player, Player, QAfterSortBy> thenByAcqValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'acqValue', Sort.asc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> thenByAcqValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'acqValue', Sort.desc);
    });
  }
...
extension PlayerQueryWhereDistinct on QueryBuilder<Player, Player, QDistinct> {
  QueryBuilder<Player, Player, QDistinct> distinctByAcqValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'acqValue');
    });
  }
...
extension PlayerQueryProperty on QueryBuilder<Player, Player, QQueryProperty> {
  ...
  QueryBuilder<Player, int, QQueryOperations> acqValueProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'acqValue');
    });
  }
